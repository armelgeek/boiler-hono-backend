...
Home.get('/', (c) => {
  const title = 'API de BoilerHono'
  const description =
    "L'API de BoilerHono offre un accès complet aux fonctionnalités de la plateforme, permettant une intégration simple et efficace de nos services."
